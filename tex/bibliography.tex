...
\bibitem{hystrix-ex} Getting Started | Circuit Breaker - \url{https://spring.io/guides/gs/circuit-breaker/} (Last access: 2021/02/20, 5 pm)

\bibitem{hystrix-eol} Hystrix EOL - \url{https://github.com/Netflix/Hystrix/blob/master/README.md}

\bibitem{linkerd-traefik} Ingress Traffic - \url{https://linkerd.io/2/tasks/using-ingress/} (Last access: 2021/02/22, 3 pm)
